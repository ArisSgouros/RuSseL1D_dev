...
module parser_vars
!----------------------------------------------------------------------------------------------------------!
logical :: grafted_lo_exist, grafted_hi_exist, matrix_existA
logical :: read_field
...
integer :: bc_hi_matrixA, bc_lo_matrixA, bc_hi_grafted, bc_lo_grafted
...
integer :: nx, ns_matrixA, ns_matrix_auxA, ns_grafted_lo, ns_grafted_hi
...
real(8) :: chainlen_matrixA, chainlen_matrix_auxA, chainlen_grafted_lo, chainlen_grafted_hi, chainlen_bulk
real(8) :: ds_ave_matrixA, ds_ave_grafted_lo, ds_ave_grafted_hi
real(8) :: lx, dx_ave
