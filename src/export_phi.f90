...
subroutine export_phi(rx, phi_matrixA, phi_gr_lo, phi_gr_hi, phi_total)
!----------------------------------------------------------------------------------------------------------!
...
real(8), intent(in), dimension(0:nx) :: phi_matrixA, phi_gr_lo, phi_gr_hi, phi_total
!----------------------------------------------------------------------------------------------------------!
!export density profiles and fields

!fixit: change phi_matrix to phi_matrixA
