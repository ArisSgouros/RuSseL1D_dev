...
&              bc_lower_type, bc_upper_type, qinit, &
&              coeff_x, rr, layer_area, rx, nx, dx, chainlen, ns, ds, wa, phi, q_final, chain_type)
!----------------------------------------------------------------------------------------------------------!
use constants
use flags
!----------------------------------------------------------------------------------------------------------!
...
do kk = 1, nx-1
    ...
    call edwards(bc_lower_type, bc_upper_type, n_dir_nodes, dir_nodes_id, dir_nodes_rdiag, Rg2_per_mon, &
...
write(filename,'(''o.chain_shape_'',A6,''.out.txt'')')chain_type
