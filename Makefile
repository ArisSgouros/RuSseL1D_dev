...
cleaner:
	rm -f *.o *.mod *.exe fort.* *.out.txt *.out.bin *__genmod.f90

cleantest:
	rm -f *.o *.mod *.exe fort.* *.out.txt *.out.bin *__genmod.f90 LOG.out.txt*

cleanout:
	rm -f fort.* *.out.txt *.out.bin *__genmod.f90 LOG.out.txt*
