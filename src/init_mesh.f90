...
use parser_vars, only: spatial_integr_scheme, contour_integr_scheme, spatial_discret_scheme, lx, nx,       &
                     ...
                     & contour_discret_scheme, ns_matrixA,ns_matrixB, ns_grafted_hi, ns_grafted_lo,     &
                     & chainlen_matrixA,chainlen_matrixB, chainlen_grafted_hi, chainlen_grafted_lo, matrixA_exist,matrixB_exist,            &
                     & grafted_lo_exist, grafted_hi_exist
use constants
use arrays, only: coeff_nx, coeff_ns_matrixA,coeff_ns_matrixB, coeff_ns_grafted_lo, coeff_ns_grafted_hi,&
                & rx, rs_matrixA,rs_matrixB, rs_grafted_hi, rs_grafted_lo, dx, ds_matrixA,ds_matrixB, &
